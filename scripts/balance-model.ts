...
import { CONFIG, PRESSURE, ZOMBIE_TYPES } from '../src/game/config';
...
export function evaluateBalance() {
  ...
  return {
    generatedAt: new Date().toISOString(), profiles: PLAYER_PROFILES, pressure: PRESSURE, zombieTypes: ZOMBIE_TYPES, weapon: CONFIG.weapon,
